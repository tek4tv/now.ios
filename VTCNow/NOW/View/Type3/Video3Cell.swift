...
class Video3Cell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        //
        viewDatePicker.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(didSelectDatePicker(_:))))
    }
    deinit {
        NotificationCenter.default.removeObserver(self)
    }
    @objc func didSelectDatePicker(_ sender: Any){
