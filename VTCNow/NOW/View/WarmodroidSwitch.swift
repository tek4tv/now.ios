...
class WarmodroidSwitch: UIView {
    ...
    var isOn = false
    var onThumbColor = #colorLiteral(red: 0.4832811952, green: 0.001460217754, blue: 0.2449635565, alpha: 1)
    var offThumbColor = UIColor.darkGray
    var onBackgroundColor = UIColor.lightGray
    var offBackgroungColor = UIColor.lightGray
